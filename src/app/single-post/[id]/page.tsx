...
// json data
import allPostsData from "@/src/data/posts/allPostsData.json";
import allCategoryData from "@/src/data/categories/allCategoryData.json";
...
const SinglePost = ({ params }: SinglePostProps) => {
  const postData = allPostsData.find((post) => post.id === Number(params?.id));
        ...
        <div className="container mx-auto px-5 md:px-0 font-work">
          ...
          <div className="text-sm breadcrumbs py-8">
            <ul>
              ...
              <li className={`text-base-content/60`}>{postData?.title}</li>
            </ul>
          </div>
          {/*   Post Content */}
          <div className="flex flex-col lg:grid lg:grid-cols-12 gap-8 items-start">
            <div className="col-span-12 lg:col-span-8">
              <div className="py-5">
                <Link href={postData?.category[0].link || "/"}>
                  ...
                  <div className=" flex items-center gap-3">
                    <div className="avatar">
                      <div className="w-9 rounded-full">
                        <Image
                          src={
                            postData?.avatar || "https://placehold.it/100x100"
                          }
                          alt="avatar"
                          width={100}
                          height={100}
              ...
              <div className="mt-8">
                <Image
                  ...
                  src={
                    postData?.featuredmedia?.sourceUrl ||
                    "https://placehold.it/800x462"
                  }
                  width={800}
                  height={462}
                />
              ...
              <div className="font-serif">
                <div className="mt-8">
                  <p className="text-xl text-base-content/80 font-serif">
                    ...
                    be stressful and overwhelming, especially if you dont plan
                    and prepare adequately. In this blog article, well explore
                    tips and tricks for a memorable journey and how to make the
                    most of your travels. <br /> <br /> One of the most
                    rewarding aspects of traveling is immersing yourself in the
                    local culture and customs. This includes trying local
                    cuisine, attending cultural events and festivals, and
                  ...
                  <p className="text-xl text-base-content/80 font-serif">
                    ...
                    Recusandae porro laborum repudiandae deserunt enim repellat
                    ullam architecto possimus nemo? Eaque a suscipit neque. Rem
                    iusto distinctio odio veritatis provident architecto.
                  </p>
                </div>
                <div className="p-8 bg-base-200 rounded-xl border-l-4  border-base-content/10 mt-8">
                  <p className="text-base-content italic text-2xl font-serif">
                    ...
                    health risks, so its crucial to take precautions to stay
                    safe and healthy. ”
                  </p>
                </div>
                <div className="mt-8">
            ...
            <Sidebar data={allPostsData} categoryData={allCategoryData} />
          </div>
        </div>
      </section>
    </main>
